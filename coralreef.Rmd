...
yini  <- c(M = 0.6, C = 0.1, T = .3, P = .2, X = 0.9)
times <- seq(0, 100, by = 0.1)
...
a. The long-term dynamics for this reef do not look very good. Macroalgae, even when parrotfish population is set to 0.99, takes over the coral. As macroalgae grows, however, so does conservation opionion. Conservation opinion seems to have grown too late to create change in this ecosystem.
